...
export default function CashCardOrderConfirmation({
  ...
  useEffect(() => {
    ...
    if (storedSessionId) {
      ...
      router.replace(
        `/customer/${tableId}/session/${storedSessionId}/cash-card-order-confirmation`
      );
    }
  }, [tableId, router]);
  ...
  return (
    <div className="min-h-screen bg-[#ececec] flex flex-col">
      ...
      <div className="absolute top-6 right-6 text-sm font-semibold text-black">
        Table: {tableId}
      </div>
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        <div className="flex flex-col items-center w-full">
          ...
          />
          <h2 className="font-bold text-black text-2xl mt-6 mb-2 text-center">
            YOUR ORDER WILL ARRIVE SOON.
          </h2>
          <p className="text-gray-800 text-center mb-6 text-lg">
            If you need further assistance,
            <br />
            please do not hesitate to approach any of our staff.
            <br />
            Thank you!
          </p>
